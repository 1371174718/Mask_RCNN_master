...
COCO_WEIGHTS_PATH = os.path.join(ROOT_DIR, "../cylinderBlock/mask_rcnn_coco.h5")
...
class BalloonDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        self.add_class("spotDataset", 1, "spotDataset")
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not a blockDataset dataset image, delegate to parent class.
        image_info = self.image_info[image_id]
        if image_info["source"] != "spotDataset":
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect spots.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/spotDataset/dataset/",
